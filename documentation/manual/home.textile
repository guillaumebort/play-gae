...
bq. *NEW v1.6.1.1: GoogleAppEngine SDK 1.6.1.1 support*
...
Then edit the **conf/dependencies.yml** file to enable the GAE module:
...
p(note). **This app is available online** at "http://mandubian-play-gae.appspot.com":http://mandubian-play-gae.appspot.com.
